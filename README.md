This repository holds the source code for my solution to the Jack's Car Rental problem from *Reinforcement Learning: An Introduction* by Sutton and Barto (2012).
